...
def create_app():
    ...
    with app.app_context():
        ...
        if not db.session.execute(text("SELECT id FROM producto LIMIT 1")).first():
            productos = [
                Producto(nombre='Hamburguesa La Salvaje', descripcion='Carne de res premium con salsa picante artesanal, jalapeÃÂ±os, cebolla morada y aderezos especiales.', precio=18.99, img='https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=400', categoria='comida'),
                Producto(nombre='Hamburguesa Clasica', descripcion='Carne de res, queso cheddar, lechuga, tomate y salsa especial.', precio=15.99, img='https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=400', categoria='comida'),
                Producto(nombre='Hamburguesa Delirio', descripcion='Doble carne premium, doble queso, bacon artesanal, piÃÂ±a asada y salsa delirante.', precio=22.99, img='https://images.unsplash.com/photo-1551782450-a2132b4ba21d?w=400', categoria='comida'),
                Producto(nombre='Soda de Lulo', descripcion='Refresco natural de lulo colombiano, refrescante y exotico.', precio=4.99, img='https://images.unsplash.com/photo-1622483767028-3f66f32aef97?w=400', categoria='bebida'),
                Producto(nombre='Soda de Maracuya', descripcion='Refresco de maracuya colombiano, dulce y acido perfecto.', precio=4.99, img='https://images.unsplash.com/photo-1622483767028-3f66f32aef97?w=400', categoria='bebida'),
                ...
                Producto(nombre='Waffle Encanto', descripcion='Waffle magico con chocolate blanco, frambuesas y almendras tostadas.', precio=15.99, img='https://images.unsplash.com/photo-1499636136210-6f4ee915583e?w=400', categoria='postre')
            ]
