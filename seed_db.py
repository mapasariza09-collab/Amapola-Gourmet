...
with app.app_context():
    ...
    if not Producto.query.first():
        productos = [
            Producto(nombre='Hamburguesa ClÃ¡sica', descripcion='Carne de res, queso cheddar, lechuga, tomate y salsa especial.', precio=12.99, img='https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=400'),
            ...
            Producto(nombre='Hamburguesa Picante', descripcion='Carne picante, jalapeÃ±os, queso pepper jack y salsa chipotle.', precio=13.50, img='https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?w=400')
        ]
