    ...
    with app.app_context():
        ...
        if not db.session.execute(text("SELECT id FROM producto LIMIT 1")).first():
            productos = [
                ...
                Producto(nombre='Soda de Maracuya', descripcion='Refresco de maracuyá colombiano, dulce y ácido perfecto.', precio=4.99, img='https://images.unsplash.com/photo-1622483767028-3f66f32aef97?w=400', categoria='bebida'),
